...
from datasets.ucf101_frame import UCF101Dataset
...
def parse_args():
    ...
    parser.add_argument('--res', default=False, type=ast.literal_eval, help='If True, use residual input.') 
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':  ########### Train #############
        ...
        if args.dataset == 'ucf101':
            test_dataset = UCF101Dataset('data/', args.cl, args.split, False, test_transforms, 10)
        elif args.dataset == 'hmdb51':
